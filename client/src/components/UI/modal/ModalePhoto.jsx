...
const src = photoSelezionato.url || (photoSelezionato.filename ? `/team-photos/${photoSelezionato.filename}` : '/placeholder.png');
	return(
		<div className="modal">
        <div className="modal-content" style ={{minWidth:"98vw"}}>
